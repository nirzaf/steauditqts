    ...
    <div class="portal-form-layout">
      <section class="panel portal-form-panel">
        ...
        <form class="portal-form" @submit.prevent="submitDetails">
          ...
          <div class="form-field-grid"><label>Legal name<input v-model="form.legalName" name="legal-name" required maxlength="160" autocomplete="organization" /></label><label>Registration / CR number<input v-model="form.registration" name="registration-number" required maxlength="80" autocomplete="off" /></label></div>
          ...
          <div class="form-field-grid"><label>Contact name<input v-model="form.contactName" name="contact-name" required maxlength="80" autocomplete="name" /></label><label>Email<input v-model="form.contactEmail" name="contact-email" required type="email" maxlength="160" autocomplete="email" /></label><label>Phone<input v-model="form.phone" name="contact-phone" required maxlength="40" autocomplete="tel" /></label></div>
          ...
          <div class="form-field-grid"><label>Reporting period<input v-model="form.servicePeriod" name="reporting-period" required maxlength="120" autocomplete="off" /></label><label>Requested service<input v-model="form.serviceRequested" name="requested-service" required maxlength="160" autocomplete="off" /></label></div>
          <label>What changed or needs context?<textarea v-model="form.context" name="context" maxlength="1200" rows="4" placeholder="Ownership, systems, locations, timing, or other context…"></textarea></label>
