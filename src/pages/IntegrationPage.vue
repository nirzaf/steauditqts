...
<template>
  <div class="page">
    ...
    <section class="health-grid"><article class="health-card warn"><div class="health-card-top"><span class="health-icon"><Icon name="link" :size="18" /></span><StatusPill label="Not connected" tone="warn" /></div><h2>Microsoft Graph</h2><p>Selected-resource permissions are simulated; no tenant connection is enabled.</p><strong>Provider state: {{ providerConnected ? 'simulated' : 'not connected' }}</strong></article><article class="health-card warn"><div class="health-card-top"><span class="health-icon"><Icon name="folder" :size="18" /></span><StatusPill label="Not connected" tone="warn" /></div><h2>SharePoint</h2><p>Repository binding and version reconciliation remain synthetic.</p><strong>Latest check: {{ lastRun }}</strong></article><article class="health-card warn"><div class="health-card-top"><span class="health-icon"><Icon name="warning" :size="18" /></span><StatusPill label="Manual verification" tone="warn" /></div><h2>Purview</h2><p>Retention label observation is awaiting an explicit records-admin proof.</p><strong>Protection observation pending</strong></article><article class="health-card warn"><div class="health-card-top"><span class="health-icon"><Icon name="key" :size="18" /></span><StatusPill label="Synthetic only" tone="warn" /></div><h2>Entra ID</h2><p>Persona switching is a walkthrough control, not production identity.</p><strong>No live identities connected</strong></article></section>
