...
<template>
  <div class="page artifacts-page">
    ...
    <LocalFixtureNotice v-if="sharedDemoEnabled"
      title="Local artifact index is read-only"
      description="The shared workflow and approval queue are authoritative in shared mode. Artifact rows and inspection receipts on this page remain browser-local reference data." />
