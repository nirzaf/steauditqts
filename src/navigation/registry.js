...
export const ROUTE_REGISTRY = Object.freeze({
  ...
  cycle: { label: 'Complete cycle', title: 'Complete synthetic cycle', section: 'Reference', roles: ['admin'] },
  ...
  'shared-demo': { label: 'Shared demo control room', title: 'Shared demo control room', section: 'Reference', roles: ['admin', 'accountant', 'accounting-reviewer', 'preparer', 'client', 'client-management', 'audit-senior', 'audit-manager', 'partner', 'finance', 'eqr', 'records', 'system-admin', 'compliance'] },
